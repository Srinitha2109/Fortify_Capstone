              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                <div class="space-y-2">
                  ...
                  <div class="space-y-2">
                    ...
                    @if ((insType.touched || formSubmitted()) && !currentPolicy().insuranceType) {
                      <div class="error-msg">Select an insurance type</div>
                    }
                  </div>
                    ...
                    <div class="space-y-2">
                      ...
                      <div class="relative">
                        ...
                        @if ((premium.touched || formSubmitted()) && !currentPolicy().basePremium) {
                          <div class="error-msg">Premium is required</div>
                        }
                      </div>
                      ...
                      <div class="space-y-2">
                        ...
                        <div class="relative">
                          ...
                          @if ((minC.touched || formSubmitted()) && !currentPolicy().minCoverageAmount) {
                            <div class="error-msg">Min amount is required</div>
                          }
                        </div>
                        ...
                        <div class="space-y-2">
                          ...
                          <div class="relative">
                            ...
                            @if ((maxC.touched || formSubmitted()) && !currentPolicy().maxCoverageAmount) {
                              <div class="error-msg">Max amount is required</div>
                            }
                          </div>
